...
from Shizy import telethn as bot
from Shizy.modules.urluploader import download_file
from Shizy.utils.uputils import humanbytes, progress
    ...
    if event.reply_to_msg_id:
        ...
        try:
            ...
            await bot.send_file(
                ...
                dosya,
                force_document=True,
                caption=f"Uploaded By @ShizyRobot",
            )
        except Exception as e:
            traceback.print_exc()
