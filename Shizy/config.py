...
def get_user_list(config, key):
    with open("{}/Shizy/{}".format(os.getcwd(), config), "r") as json_file:
...
class Config(object):
   ...
   SUPPORT_CHAT = os.getenv("SUPPORT_CHAT", "ShizySupport")  # Your own group for support, do not add the @
   ...
   SUPPORT_CHANNEL = os.getenv("SUPPORT_CHANNEL", "ShizyUpdates")
