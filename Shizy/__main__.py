...
import sys
import traceback
import Shizy.modules.sql.users_sql as sql
...
from Shizy.modules import ALL_MODULES
from Shizy.modules.helper_funcs.chat_status import is_user_admin
from Shizy.modules.helper_funcs.misc import paginate_modules
...
built to help you manage your group [🌻](https://telegra.ph/file/7be16c93c3a2efcb67ea0.jpg)
────────────────────
...
PRIME_IMG = "https://telegra.ph/file/992f72eae903426656775.jpg"

DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project by contacting @alvrnxz \
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("Shizy.modules." + module_name)
...
def prime_about_callback(update, context):
    ...
    if query.data == "prime_":
        ...
        query.message.edit_text(
            ...
            "\nJoin My Support Group/Channel for see or report a problem on Shizy.",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
        ...
        query.message.edit_text(
            text=f"<b>๏ Credis for Shizy</b>\n"
            f"\nHere Developers Making The ShizyRobot",
            parse_mode=ParseMode.HTML,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Varen", url="t.me/alvrnxz"),
