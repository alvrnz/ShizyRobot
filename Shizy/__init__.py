...
def get_user_list(__init__, key):
    with open("{}/Shizy/{}".format(os.getcwd(), __init__), "r") as json_file:
        return json.load(json_file)[key]

# enable logging
FORMAT = "[Shizy] %(message)s"
logging.basicConfig(
...
LOGGER = logging.getLogger('[Shizy]')
...
if ENV:
    ...
    from Shizy.config import Development as Config
...
try:
    from Shizy.antispam import antispam_restrict_user, antispam_cek_user, detect_user
...
from Shizy.modules.helper_funcs.handlers import (
