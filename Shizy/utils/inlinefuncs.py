...
from Shizy import pbot as app
from Shizy import arq
from Shizy.services.keyboard import Ikb
from Shizy.utils.pluginhelper import (
    convert_seconds_to_minutes as time_convert,
    fetch,
)
from Shizy.services.tasks import _get_tasks_text, all_tasks, rm_task
from Shizy.services.types import InlineQueryResultCachedDocument
from Shizy.modules.info import get_chat_info, get_user_info
from Shizy.modules.music import download_youtube_audio
from Shizy.utils.functions import test_speedtest
from Shizy.utils.pastebin import paste
...
async def inline_help_func(__HELP__):
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/0a7aa2dce7972be90b75d.jpg",
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main bot", url="https://t.me/ShizyRobot"),
        InlineKeyboardButton("Go Inline!", switch_inline_query_current_chat=""),
    )

    msg = f"""
**[Shizy Robot](https://t.me/ShizyRobot):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [Alvrn🪐](t.me/Alvrnxz)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
            description="Check Bot's Stats",
            thumb_url="https://telegra.ph/file/992f72eae903426656775.jpg",
            input_message_content=InputTextMessageContent(
